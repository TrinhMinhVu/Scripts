...
case $current in
	...
	echo " HDPHN"> ${HOME}/.local/status-head-line
	dunstify -h string:x-dunst-stack-tag:ports "Output to:" " headphone"
	...
	*)
    	...
    	echo " LNOUT" > ${HOME}/.local/status-head-line
	dunstify -h string:x-dunst-stack-tag:ports "Output to:" " lineout"
	polybar-msg hook ipc-head-line 1
